            ...
            >
              ...
              >
                <a-input-password
                  ...
                  :valid="false"
                />
                <ul class="pwCheckUl" style="margin-bottom: 0" v-if="formState.password !== ''">
                  <li class="pwCheckLi"
                    v-bind:class="{
                  ...
                  <li class="pwCheckLi"
                    v-bind:class="{ pw_check_is_valid: passwordValid.contains_number }"
                  >
                    Contains Number
                  </li>
                  <li class="pwCheckLi"
                  ...
                  <li class="pwCheckLi"
                    v-bind:class="{
                      pw_check_is_valid: passwordValid.contains_special_character,
                    }"
                  >
